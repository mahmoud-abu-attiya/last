...
const SubFooter = ({ settings }) => {
  return (
    <div className="sticky subFooter bottom-0 lg:p-4 lg:px-16 grid grid-cols-4 lg:bg-gray-100 z-20 lg:gap-0">
      <a href={`tel:${settings.mobile}`} className="lg:shadow-none phone bg-[green] p-4 lg:p-0 lg:bg-transparent flex items-center justify-center gap-6 md:px-10" target='_blank' rel='noreferrer'>
      ...
      <a href={`tel:${settings.phone}`} className="lg:shadow-none hours p-4 lg:p-0 lg:bg-transparent flex items-center justify-center gap-6 md:px-10 lg:border-r-2 border-gray-300" target='_blank' rel='noreferrer'>
      ...
      <a href={`mailto:${settings.email}`} className="lg:shadow-none email bg-blue-500 p-4 lg:p-0 lg:bg-transparent flex items-center justify-center gap-6 md:px-10 lg:border-r-2 border-gray-300" target='_blank' rel='noreferrer'>
      ...
      <a href={`https://api.whatsapp.com/send?phone=${settings.whatsup}`} className="lg:shadow-none whats bg-green-500 p-4 lg:p-0 lg:bg-transparent flex items-center justify-center gap-6 md:px-10 lg:border-r-2 border-gray-300" target='_blank' rel='noreferrer'>
