...
export default function Programs({ data }) {
   ...
   return (
      <section className="grid grid-cols-12 py-16 md:py-20 programs">
         <div className={`col-span-12 xl:col-span-3 px-6 ${en ? "xl:pl-16" : "xl:pr-16"} text-white xl:flex flex-col justify-between gap-4`}>
            <h2 className="text-2xl lg:text-5xl xl:w-min text-center xl:text-start">
               {en ? "The latest tourism program discounts" : "أحدث خصومات البرامج السياحية"}
            </h2>
            <div className={`hidden ${en ? "xl:flex justify-end" : "xl:block"}`} dir="rtl">
               <button
               ...
               >
                  <Image
                     ...
                     priority={true}
                  />
                  <span className="opacity-0 group-hover:opacity-100 transition text-white uppercase text-xs duration-500">
                     prev
                  </span>
               </button>
               <button
            ...
            <Link
               href="/"
               className="border-b pb-2 w-fit text-xs hidden xl:block"
            >
               {en ? "View all programmes" : "عرض كل البرامج"}
            </Link>
         </div>
            ...
            >
               <div className="swiper-wrapper">
                  <div
                     ...
                     style={{ transform: en ? `translate(-${translate}%)` : `translate(${translate}%)` }}
                  >
