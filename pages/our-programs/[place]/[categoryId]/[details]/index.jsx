...
const Details = (props) => {
   ...
   useEffect(() => {
      dispatch(
         setBacktoData({
            title: `عروض ${program.country.name}`,
            href: `/our-programs/${program.country.id}`,
         })
      );
   }, []);
         ...
         <div className="bg-gray-50 dark:bg-gray-900">
            <div className={styles.details__bg}>
              ...
              return ( */}
               ...
               <Link
                  href={"/our-programs"}
                  className="rounded-full px-4 py-2 text-xs bg-white dark:bg-gray-900 dark:text-white z-10 absolute bottom-4 block md:hidden right-4 bold"
               >
                  عودة إلى الباقات
               </Link>
               <ScrollDown />
            </div>
            <div className="md:hidden sticky bg-white dark:bg-gray-950 mb-4 shadow-md text-xs z-30 top-[8rem] left-0 w-full flex justify-between gap-5 p-2">
               <Link
                  href={"#slider"}
            ...
            <div className={`${styles.details} grid grid-cols-3`}>
               ...
               >
                  <div className="hidden md:block border-b dark:border-gray-600">
                     <Breadcrumbs
                        list={[
                           { title: "البرامج السياحية", href: "/our-programs" },
                           {
                              title: program.country.name,
                              href: `/our-programs/${program.country.id}`,
                           },
                           { title: program.category.name, href: null },
                        ]}
                     />
                  </div>
                  <p
                     className={`text-justify dark:text-gray-100 ${noto.className}`}
                  >
                        ...
                        <div className="">
                           ...
                           <div>
                              ...
                              <span className="text-xl font-bold">
                                 {program.price_after_discount} SAR
                              </span>
                           </div>
                        </div>
                        <Link
               ...
               <div
                  className={`${styles.details__form} border relative dark:border-gray-700 dark:text-white col-span-3 lg:col-span-1 dark:bg-gray-800 bg-white`}
               >
               ...
               <div className={styles.similar}>
                  ...
                  <div className={styles.similar__cards}>
                     {programs
                        ...
                        .map((prog) => (
                           <div
                              className={`dark:bg-gray-800 dark:text-white ${styles.similar__card}`}
                              key={prog?.id}
                           >
                              <div className={styles.similar__card__container}>
                                 <div
                                    className={styles.similar__img__container}
                                 >
                                    {prog?.image && (
                                       <Image
                                          src={prog?.image}
                                 ...
                                 <div className={styles.similar__card__content}>
                                    <div
                                       className={styles.similar__card__period}
                                    >
                                       <span>
                                    ...
                                    <div className={styles.similar__heading}>
                                       ...
                                       <div className={styles.stars}>
                                          {Array.from(Array(prog.rate)).map(
                                             (s, i) => (
                                    ...
                                    <div
                                       className={styles.similar__card__price}
                                    >
                                       <div>
                                          <span
                                             className={
                                                "text-secondary dark:text-white text-xl bold"
                                             }
                                          >
