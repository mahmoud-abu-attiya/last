                    ...
                    {fbs.map((fb, i) => {
                      return (
                        <li key={i} className="flex items-center gap-2">
                          <span className="block h-2 w-2 rounded-full bg-black dark:bg-white"></span> {fb}
                        </li>
                      )
                    })}
                  </ul>
            ...
            <div className={styles.similar}>
              ...
              <div className={styles.similar__cards}>
                {offers
                  ...
                  .slice(0, 3)
                  .map((offer) => (
                    <div key={offer.id} className='shadow-md border dark:border-gray-700 overflow-hidden mx-2 rounded-lg'>
                      <div className="relative h-[13rem]">
                        <Image src={offer.image} alt="any" fill quality={50} className='object-cover' />
                      </div>
                      <div className="flex flex-col gap-4 p-4 pt-8 bg-gray-100  dark:text-white  dark:bg-gray-800">
                        ...
                        <div className="border-t pt-4 dark:border-gray-700 flex items-center justify-between gap-4">
                          ...
                          <Link href={`/special-offers/${offer.id}`} className='px-4 py-3 rounded-md bg-secondary text-white text-sm'>
                            عرض التفاصيل
                          </Link>
                        </div>
                      </div>
